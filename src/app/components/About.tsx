...
export default function AboutMe() {
  ...
  return (
    ...
    >
      <div className="max-w-4xl w-full bg-white rounded-xl shadow-lg p-6 sm:p-8 md:p-16 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-6 text-sm sm:text-base">
          ...
          {/* Skills */}
          <div>
            <h2 className="text-lg sm:text-2xl font-semibold text-[#B99470] mb-3 sm:mb-4">Skills</h2>
          ...
          {/* Tools */}
          <div>
            <h2 className="text-lg sm:text-2xl font-semibold text-[#B99470] mb-3 sm:mb-4">Tools</h2>
          ...
          <div className="mt-4 sm:mt-6">
            ...
            >
              {[
                ...
                { src: "/ksm-android.jpeg", desc: "Studi Banding KSM Android x BNCC" },
              ].map(({ src, desc }, idx) => (
                <div
                  key={idx}
          ...
          <div className="mt-4 sm:mt-6 flex flex-col items-start gap-3 sm:gap-4">
            <h2 className="text-lg sm:text-2xl font-semibold text-[#B99470]">Find Me</h2>
